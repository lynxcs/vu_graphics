...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ui,depthTest:!1,depthWrite:!1})}function Ah(){return new $n({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:wc(),fragmentShader:`
		...
		`,blending:ui,depthTest:!1,depthWrite:!1})}function Th(){return new $n({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:wc(),fragmentShader:`
	...
	`}function L_(r){let t=new WeakMap,e=null;function n(a){if(a&&a.isTexture){const l=a.mapping,c=l===xl||l===yl,h=l===Cs||l===Rs;if(c||h){let d=t.get(a);const u=d!==void 0?d.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==u)return e===null&&(e=new Eh(r)),d=c?e.fromEquirectangular(a,d):e.fromCubemap(a,d),d.texture.pmremVersion=a.pmremVersion,t.set(a,d),d.texture;if(d!==void 0)return d.texture;{const f=a.image;return c&&f&&f.height>0||h&&f&&i(f)?(e===null&&(e=new Eh(r)),d=c?e.fromEquirectangular(a):e.fromCubemap(a),d.texture.pmremVersion=a.pmremVersion,t.set(a,d),a.addEventListener("dispose",s),d.texture):null}}}return a}function i(a){let l=0;const c=6;for(let h=0;h<c;h++)a[h]!==void 0&&l++;return l===c}function s(a){const l=a.target;l.removeEventListener("dispose",s);const c=t.get(l);c!==void 0&&(t.delete(l),c.dispose())}function o(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:o}}function I_(r){const t={};function e(n){if(t[n]!==void 0)return t[n];let i;switch(n){case"WEBGL_depth_texture":i=r.getExtension("WEBGL_depth_texture")||r.getExtension("MOZ_WEBGL_depth_texture")||r.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=r.getExtension("EXT_texture_filter_anisotropic")||r.getExtension("MOZ_EXT_texture_filter_anisotropic")||r.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=r.getExtension("WEBGL_compressed_texture_s3tc")||r.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=r.getExtension("WEBGL_compressed_texture_pvrtc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=r.getExtension(n)}return t[n]=i,i}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const i=e(n);return i===null&&sr("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function D_(r,t,e,n){const i={},s=new WeakMap;function o(d){const u=d.target;u.index!==null&&t.remove(u.index);for(const g in u.attributes)t.remove(u.attributes[g]);for(const g in u.morphAttributes){const _=u.morphAttributes[g];for(let p=0,m=_.length;p<m;p++)t.remove(_[p])}u.removeEventListener("dispose",o),delete i[u.id];const f=s.get(u);f&&(t.remove(f),s.delete(u)),n.releaseStatesOfGeometry(u),u.isInstancedBufferGeometry===!0&&delete u._maxInstanceCount,e.memory.geometries--}function a(d,u){return i[u.id]===!0||(u.addEventListener("dispose",o),i[u.id]=!0,e.memory.geometries++),u}function l(d){const u=d.attributes;for(const g in u)t.update(u[g],r.ARRAY_BUFFER);const f=d.morphAttributes;for(const g in f){const _=f[g];for(let p=0,m=_.length;p<m;p++)t.update(_[p],r.ARRAY_BUFFER)}}function c(d){const u=[],f=d.index,g=d.attributes.position;let _=0;if(f!==null){const v=f.array;_=f.version;for(let x=0,y=v.length;x<y;x+=3){const A=v[x+0],E=v[x+1],b=v[x+2];u.push(A,E,E,b,b,A)}}else if(g!==void 0){const v=g.array;_=g.version;for(let x=0,y=v.length/3-1;x<y;x+=3){const A=x+0,E=x+1,b=x+2;u.push(A,E,E,b,b,A)}}else return;const p=new(sd(u)?cd:ld)(u,1);p.version=_;const m=s.get(d);m&&t.remove(m),s.set(d,p)}function h(d){const u=s.get(d);if(u){const f=d.index;f!==null&&u.version<f.version&&c(d)}else c(d);return s.get(d)}return{get:a,update:l,getWireframeAttribute:h}}function U_(r,t,e){let n;function i(u){n=u}let s,o;function a(u){s=u.type,o=u.bytesPerElement}function l(u,f){r.drawElements(n,f,s,u*o),e.update(f,n,1)}function c(u,f,g){g!==0&&(r.drawElementsInstanced(n,f,s,u*o,g),e.update(f,n,g))}function h(u,f,g){if(g===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,f,0,s,u,0,g);let p=0;for(let m=0;m<g;m++)p+=f[m];e.update(p,n,1)}function d(u,f,g,_){if(g===0)return;const p=t.get("WEBGL_multi_draw");if(p===null)for(let m=0;m<u.length;m++)c(u[m]/o,f[m],_[m]);else{p.multiDrawElementsInstancedWEBGL(n,f,0,s,u,0,_,0,g);let m=0;for(let v=0;v<g;v++)m+=f[v];for(let v=0;v<_.length;v++)e.update(m,n,_[v])}}this.setMode=i,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=h,this.renderMultiDrawInstances=d}function N_(r){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,o,a){switch(e.calls++,o){case r.TRIANGLES:e.triangles+=a*(s/3);break;case r.LINES:e.lines+=a*(s/2);break;case r.LINE_STRIP:e.lines+=a*(s-1);break;case r.LINE_LOOP:e.lines+=a*s;break;case r.POINTS:e.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function i(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:i,update:n}}function F_(r,t,e){const n=new WeakMap,i=new ye;function s(o,a,l){const c=o.morphTargetInfluences,h=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,d=h!==void 0?h.length:0;let u=n.get(a);if(u===void 0||u.count!==d){let M=function(){P.dispose(),n.delete(a),a.removeEventListener("dispose",M)};var f=M;u!==void 0&&u.texture.dispose();const g=a.morphAttributes.position!==void 0,_=a.morphAttributes.normal!==void 0,p=a.morphAttributes.color!==void 0,m=a.morphAttributes.position||[],v=a.morphAttributes.normal||[],x=a.morphAttributes.color||[];let y=0;g===!0&&(y=1),_===!0&&(y=2),p===!0&&(y=3);let A=a.attributes.position.count*y,E=1;A>t.maxTextureSize&&(E=Math.ceil(A/t.maxTextureSize),A=t.maxTextureSize);const b=new Float32Array(A*E*4*d),P=new od(b,A,E,d);P.type=gn,P.needsUpdate=!0;const S=y*4;for(let R=0;R<d;R++){const U=m[R],L=v[R],I=x[R],F=A*E*4*R;for(let D=0;D<U.count;D++){const X=D*S;g===!0&&(i.fromBufferAttribute(U,D),b[F+X+0]=i.x,b[F+X+1]=i.y,b[F+X+2]=i.z,b[F+X+3]=0),_===!0&&(i.fromBufferAttribute(L,D),b[F+X+4]=i.x,b[F+X+5]=i.y,b[F+X+6]=i.z,b[F+X+7]=0),p===!0&&(i.fromBufferAttribute(I,D),b[F+X+8]=i.x,b[F+X+9]=i.y,b[F+X+10]=i.z,b[F+X+11]=I.itemSize===4?i.w:1)}}u={count:d,texture:P,size:new wt(A,E)},n.set(a,u),a.addEventListener("dispose",M)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(r,"morphTexture",o.morphTexture,e);else{let g=0;for(let p=0;p<c.length;p++)g+=c[p];const _=a.morphTargetsRelative?1:1-g;l.getUniforms().setValue(r,"morphTargetBaseInfluence",_),l.getUniforms().setValue(r,"morphTargetInfluences",c)}l.getUniforms().setValue(r,"morphTargetsTexture",u.texture,e),l.getUniforms().setValue(r,"morphTargetsTextureSize",u.size)}return{update:s}}function B_(r,t,e,n){let i=new WeakMap;function s(l){const c=n.render.frame,h=l.geometry,d=t.get(l,h);if(i.get(d)!==c&&(t.update(d),i.set(d,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),i.get(l)!==c&&(e.update(l.instanceMatrix,r.ARRAY_BUFFER),l.instanceColor!==null&&e.update(l.instanceColor,r.ARRAY_BUFFER),i.set(l,c))),l.isSkinnedMesh){const u=l.skeleton;i.get(u)!==c&&(u.update(),i.set(u,c))}return d}function o(){i=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),e.remove(c.instanceMatrix),c.instanceColor!==null&&e.remove(c.instanceColor)}return{update:s,dispose:o}}class md extends Re{constructor(t,e,n,i,s,o,a,l,c,h=Es){if(h!==Es&&h!==Ls)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===Es&&(n=_i),n===void 0&&h===Ls&&(n=Ps),super(null,i,s,o,a,l,h,n,c),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=a!==void 0?a:ke,this.minFilter=l!==void 0?l:ke,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){const e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}}const gd=new Re,Ch=new md(1,1),_d=new od,vd=new wp,xd=new dd,Rh=[],Ph=[],Lh=new Float32Array(16),Ih=new Float32Array(9),Dh=new Float32Array(4);function Ns(r,t,e){const n=r[0];if(n<=0||n>0)return r;const i=t*e;let s=Rh[i];if(s===void 0&&(s=new Float32Array(i),Rh[i]=s),t!==0){n.toArray(s,0);for(let o=1,a=0;o!==t;++o)a+=e,r[o].toArray(s,a)}return s}function Se(r,t){if(r.length!==t.length)return!1;for(let e=0,n=r.length;e<n;e++)if(r[e]!==t[e])return!1;return!0}function we(r,t){for(let e=0,n=t.length;e<n;e++)r[e]=t[e]}function Jo(r,t){let e=Ph[t];e===void 0&&(e=new Int32Array(t),Ph[t]=e);for(let n=0;n!==t;++n)e[n]=r.allocateTextureUnit();return e}function O_(r,t){const e=this.cache;e[0]!==t&&(r.uniform1f(this.addr,t),e[0]=t)}function z_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(r.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Se(e,t))return;r.uniform2fv(this.addr,t),we(e,t)}}function V_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(r.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(r.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(Se(e,t))return;r.uniform3fv(this.addr,t),we(e,t)}}function H_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(r.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Se(e,t))return;r.uniform4fv(this.addr,t),we(e,t)}}function k_(r,t){const e=this.cache,n=t.elements;if(n===void 0){if(Se(e,t))return;r.uniformMatrix2fv(this.addr,!1,t),we(e,t)}else{if(Se(e,n))return;Dh.set(n),r.uniformMatrix2fv(this.addr,!1,Dh),we(e,n)}}function G_(r,t){const e=this.cache,n=t.elements;if(n===void 0){if(Se(e,t))return;r.uniformMatrix3fv(this.addr,!1,t),we(e,t)}else{if(Se(e,n))return;Ih.set(n),r.uniformMatrix3fv(this.addr,!1,Ih),we(e,n)}}function W_(r,t){const e=this.cache,n=t.elements;if(n===void 0){if(Se(e,t))return;r.uniformMatrix4fv(this.addr,!1,t),we(e,t)}else{if(Se(e,n))return;Lh.set(n),r.uniformMatrix4fv(this.addr,!1,Lh),we(e,n)}}function X_(r,t){const e=this.cache;e[0]!==t&&(r.uniform1i(this.addr,t),e[0]=t)}function q_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(r.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Se(e,t))return;r.uniform2iv(this.addr,t),we(e,t)}}function Y_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(r.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(Se(e,t))return;r.uniform3iv(this.addr,t),we(e,t)}}function $_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(r.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Se(e,t))return;r.uniform4iv(this.addr,t),we(e,t)}}function j_(r,t){const e=this.cache;e[0]!==t&&(r.uniform1ui(this.addr,t),e[0]=t)}function K_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(r.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Se(e,t))return;r.uniform2uiv(this.addr,t),we(e,t)}}function Z_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(r.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(Se(e,t))return;r.uniform3uiv(this.addr,t),we(e,t)}}function J_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(r.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Se(e,t))return;r.uniform4uiv(this.addr,t),we(e,t)}}function Q_(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i);let s;this.type===r.SAMPLER_2D_SHADOW?(Ch.compareFunction=id,s=Ch):s=gd,e.setTexture2D(t||s,i)}function t0(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),e.setTexture3D(t||vd,i)}function e0(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),e.setTextureCube(t||xd,i)}function n0(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),e.setTexture2DArray(t||_d,i)}function i0(r){switch(r){case 5126:return O_;case 35664:return z_;case 35665:return V_;case 35666:return H_;case 35674:return k_;case 35675:return G_;case 35676:return W_;case 5124:case 35670:return X_;case 35667:case 35671:return q_;case 35668:case 35672:return Y_;case 35669:case 35673:return $_;case 5125:return j_;case 36294:return K_;case 36295:return Z_;case 36296:return J_;case 35678:case 36198:case 36298:case 36306:case 35682:return Q_;case 35679:case 36299:case 36307:return t0;case 35680:case 36300:case 36308:case 36293:return e0;case 36289:case 36303:case 36311:case 36292:return n0}}function s0(r,t){r.uniform1fv(this.addr,t)}function r0(r,t){const e=Ns(t,this.size,2);r.uniform2fv(this.addr,e)}function o0(r,t){const e=Ns(t,this.size,3);r.uniform3fv(this.addr,e)}function a0(r,t){const e=Ns(t,this.size,4);r.uniform4fv(this.addr,e)}function l0(r,t){const e=Ns(t,this.size,4);r.uniformMatrix2fv(this.addr,!1,e)}function c0(r,t){const e=Ns(t,this.size,9);r.uniformMatrix3fv(this.addr,!1,e)}function h0(r,t){const e=Ns(t,this.size,16);r.uniformMatrix4fv(this.addr,!1,e)}function u0(r,t){r.uniform1iv(this.addr,t)}function d0(r,t){r.uniform2iv(this.addr,t)}function f0(r,t){r.uniform3iv(this.addr,t)}function p0(r,t){r.uniform4iv(this.addr,t)}function m0(r,t){r.uniform1uiv(this.addr,t)}function g0(r,t){r.uniform2uiv(this.addr,t)}function _0(r,t){r.uniform3uiv(this.addr,t)}function v0(r,t){r.uniform4uiv(this.addr,t)}function x0(r,t,e){const n=this.cache,i=t.length,s=Jo(e,i);Se(n,s)||(r.uniform1iv(this.addr,s),we(n,s));for(let o=0;o!==i;++o)e.setTexture2D(t[o]||gd,s[o])}function y0(r,t,e){const n=this.cache,i=t.length,s=Jo(e,i);Se(n,s)||(r.uniform1iv(this.addr,s),we(n,s));for(let o=0;o!==i;++o)e.setTexture3D(t[o]||vd,s[o])}function M0(r,t,e){const n=this.cache,i=t.length,s=Jo(e,i);Se(n,s)||(r.uniform1iv(this.addr,s),we(n,s));for(let o=0;o!==i;++o)e.setTextureCube(t[o]||xd,s[o])}function S0(r,t,e){const n=this.cache,i=t.length,s=Jo(e,i);Se(n,s)||(r.uniform1iv(this.addr,s),we(n,s));for(let o=0;o!==i;++o)e.setTexture2DArray(t[o]||_d,s[o])}function w0(r){switch(r){case 5126:return s0;case 35664:return r0;case 35665:return o0;case 35666:return a0;case 35674:return l0;case 35675:return c0;case 35676:return h0;case 5124:case 35670:return u0;case 35667:case 35671:return d0;case 35668:case 35672:return f0;case 35669:case 35673:return p0;case 5125:return m0;case 36294:return g0;case 36295:return _0;case 36296:return v0;case 35678:case 36198:case 36298:case 36306:case 35682:return x0;case 35679:case 36299:case 36307:return y0;case 35680:case 36300:case 36308:case 36293:return M0;case 36289:case 36303:case 36311:case 36292:return S0}}class E0{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=i0(e.type)}}class b0{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=w0(e.type)}}class A0{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const i=this.seq;for(let s=0,o=i.length;s!==o;++s){const a=i[s];a.setValue(t,e[a.id],n)}}}const ka=/(\w+)(\])?(\[|\.)?/g;function Uh(r,t){r.seq.push(t),r.map[t.id]=t}function T0(r,t,e){const n=r.name,i=n.length;for(ka.lastIndex=0;;){const s=ka.exec(n),o=ka.lastIndex;let a=s[1];const l=s[2]==="]",c=s[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===i){Uh(e,c===void 0?new E0(a,r,t):new b0(a,r,t));break}else{let d=e.map[a];d===void 0&&(d=new A0(a),Uh(e,d)),e=d}}}class Lo{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const s=t.getActiveUniform(e,i),o=t.getUniformLocation(e,s.name);T0(s,o,this)}}setValue(t,e,n,i){const s=this.map[e];s!==void 0&&s.setValue(t,n,i)}setOptional(t,e,n){const i=e[n];i!==void 0&&this.setValue(t,n,i)}static upload(t,e,n,i){for(let s=0,o=e.length;s!==o;++s){const a=e[s],l=n[a.id];l.needsUpdate!==!1&&a.setValue(t,l.value,i)}}static seqWithValue(t,e){const n=[];for(let i=0,s=t.length;i!==s;++i){const o=t[i];o.id in e&&n.push(o)}return n}}function Nh(r,t,e){const n=r.createShader(t);return r.shaderSource(n,e),r.compileShader(n),n}const C0=37297;let R0=0;function P0(r,t){const e=r.split(`
`),n=[],i=Math.max(t-6,0),s=Math.min(t+6,e.length);for(let o=i;o<s;o++){const a=o+1;n.push(`${a===t?">":" "} ${a}: ${e[o]}`)}return n.join(`
`)}function L0(r){const t=Xt.getPrimaries(Xt.workingColorSpace),e=Xt.getPrimaries(r);let n;switch(t===e?n="":t===Oo&&e===Bo?n="LinearDisplayP3ToLinearSRGB":t===Bo&&e===Oo&&(n="LinearSRGBToLinearDisplayP3"),r){case yi:case jo:return[n,"LinearTransferOETF"];case wn:case xc:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",r),[n,"LinearTransferOETF"]}}function Fh(r,t,e){const n=r.getShaderParameter(t,r.COMPILE_STATUS),i=r.getShaderInfoLog(t).trim();if(n&&i==="")return"";const s=/ERROR: 0:(\d+)/.exec(i);if(s){const o=parseInt(s[1]);return e.toUpperCase()+`

`+i+`

`+P0(r.getShaderSource(t),o)}else return i}function I0(r,t){const e=L0(t);return`vec4 ${r}( vec4 value ) { return ${e[0]}( ${e[1]}( value ) ); }`}function D0(r,t){let e;switch(t){case Nf:e="Linear";break;case Ff:e="Reinhard";break;case Bf:e="Cineon";break;case Of:e="ACESFilmic";break;case Vf:e="AgX";break;case Hf:e="Neutral";break;case zf:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+r+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const Zr=new B;function U0(){Xt.getLuminanceCoefficients(Zr);const r=Zr.x.toFixed(4),t=Zr.y.toFixed(4),e=Zr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
`)}function N0(r){return[r.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",r.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(tr).join(`
`)}function F0(r){const t=[];for(const e in r){const n=r[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function B0(r,t){const e={},n=r.getProgramParameter(t,r.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const s=r.getActiveAttrib(t,i),o=s.name;let a=1;s.type===r.FLOAT_MAT2&&(a=2),s.type===r.FLOAT_MAT3&&(a=3),s.type===r.FLOAT_MAT4&&(a=4),e[o]={type:s.type,location:r.getAttribLocation(t,o),locationSize:a}}return e}function tr(r){return r!==""}function Bh(r,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return r.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Oh(r,t){return r.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const O0=/^[ \t]*#include +<([\w\d./]+)>/gm;function jl(r){return r.replace(O0,V0)}const z0=new Map;function V0(r,t){let e=Nt[t];if(e===void 0){const n=z0.get(t);if(n!==void 0)e=Nt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return jl(e)}const H0=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function zh(r){return r.replace(H0,k0)}function k0(r,t,e,n){let i="";for(let s=parseInt(t);s<parseInt(e);s++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return i}function Vh(r){let t=`precision ${r.precision} float;
...
#define LOW_PRECISION`),t}function G0(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===Gu?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===af?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===Hn&&(t="SHADOWMAP_TYPE_VSM"),t}function W0(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case Cs:case Rs:t="ENVMAP_TYPE_CUBE";break;case Yo:t="ENVMAP_TYPE_CUBE_UV";break}return t}function X0(r){let t="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case Rs:t="ENVMAP_MODE_REFRACTION";break}return t}function q0(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case Wu:t="ENVMAP_BLENDING_MULTIPLY";break;case Df:t="ENVMAP_BLENDING_MIX";break;case Uf:t="ENVMAP_BLENDING_ADD";break}return t}function Y0(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function $0(r,t,e,n){const i=r.getContext(),s=e.defines;let o=e.vertexShader,a=e.fragmentShader;const l=G0(e),c=W0(e),h=X0(e),d=q0(e),u=Y0(e),f=N0(e),g=F0(s),_=i.createProgram();let p,m,v=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+m);const x=v+p+o,y=v+m+a,A=Nh(i,i.VERTEX_SHADER,x),E=Nh(i,i.FRAGMENT_SHADER,y);i.attachShader(_,A),i.attachShader(_,E),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function b(R){if(r.debug.checkShaderErrors){const U=i.getProgramInfoLog(_).trim(),L=i.getShaderInfoLog(A).trim(),I=i.getShaderInfoLog(E).trim();let F=!0,D=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(F=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,A,E);else{const X=Fh(i,A,"vertex"),k=Fh(i,E,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
}`,mw="/vu_graphics/assets/smooth_snow-Dzuv2eAI.jpg",gw=!1,Fc=.2,Vd=0,_w=0,he=128;function Hd(r,t,e){let n=document.createElement("canvas");return n.id=e,n.width=r,n.height=t,n}document.body.appendChild(Hd(he,he,"canvasD"));document.body.appendChild(Hd(he,he,"canvasN"));function Bc(r,t,e,n=!1){const{x:i,z:s,y:o}=e,a=t.getImageData(0,0,he,he);n===!1&&(r.elementSize=Math.abs(i)/a.width,r.data=[...Array(a.width)].map(d=>Array(a.height).fill(0)));const l=r.data;let c=9999.999,h=-9999.99;for(let d=0;d<a.height;d++){const u=d*a.height,f=l[o<0?a.height-1-d:d];for(let g=0;g<a.width;g++){const p=a.data[(u+g)*4]/255*s+Vd,m=i<0?g:a.width-1-g;p<c&&(c=p),p>h&&(h=p),f[m]=p}}r.maxValue=h,r.minValue=c,r.update()}ln.prototype.computeBoundsTree=Sy;ln.prototype.diposeBoundsTree=wy;ce.prototype.raycast=xy;const Ze=new Tv,Kn=new ow({gravity:new w(0,-9.81,0)});Kn.broadphase=new Ms(Kn);Kn.defaultContactMaterial.friction=2;const kd=new Bs,xi=new en(75,window.innerWidth/window.innerHeight,.1,1e3);xi.position.set(5,3.89,-.133);xi.rotation.set(-.554,.387,.22);xi.quaternion.set(.89,-.2755,.3354,.103);const Gd=new kv;Gd.position.set(1,1,1);Ze.add(Gd);Ze.background=new Gt(10526880);Ze.fog=new Ec(10526880,10,50);const vw=new Gv(4210752);Ze.add(vw);const Rn=new Av({antialias:!0});Rn.setSize(window.innerWidth,window.innerHeight);Rn.setPixelRatio(window.devicePixelRatio);document.body.appendChild(Rn.domElement);const yr=new Yv(xi,Rn.domElement);yr.enablePan=!1;yr.enableDamping=!0;const Wd=document.getElementById("canvasD"),an=Wd.getContext("2d",{willReadFrequently:!0}),Xd=document.getElementById("canvasN"),pi=Xd.getContext("2d");pi.fillStyle="#7f7fff";pi.fillRect(0,0,he,he);an.fillStyle="#FFFFFF";an.fillRect(0,0,he,he);ra(an,pi);const Oc=new yd(Wd);new yd(Xd);const xw=new zv().load(mw),dr=8,qd=new gr(dr,dr,he,he),yw={bumpTexture:{value:Oc},bumpScale:{value:Fc},colorMap:{value:xw}},Mr=new $n({wireframe:gw,uniforms:yw,vertexShader:fw,fragmentShader:pw}),ia=new ce(qd,Mr);qd.computeBoundsTree();ia.rotation.x=-Math.PI/2;Ze.add(ia);const Yd=new ct({type:ct.STATIC,shape:new IM,material:kd});Yd.quaternion.setFromEuler(-Math.PI/2,0,0);Kn.addBody(Yd);const As=new Wv;As.firstHitOnly=!0;let pl;const ac=new wt;let Hu=Date.now(),ko=!1,sa=!1,zc=!1;const Uo=[],ml=15,gl=15;for(let r=0;r<ml;r++){Uo.push([]);for(let t=0;t<gl;t++){if(r===0||r===ml-1||t===0||t===gl-1){Uo[r].push(3);continue}const e=Math.cos(r/ml*Math.PI*2)*Math.cos(t/gl*Math.PI*2)+2;Uo[r].push(e)}}const Vc={x:dr,z:Fc,y:-2};let mi=new DM(Uo,{elementSize:4});Bc(mi,an,Vc);const gi=new ct({mass:0,isTrigger:!0,shape:mi,type:ct.STATIC});gi.quaternion.setFromEuler(-Math.PI/2,0,.5*Math.PI);gi.position.set(dr/2,-(Vd+_w),dr/2);Kn.addBody(gi);function Mw(){pi.fillStyle="#7f7fff",pi.fillRect(0,0,he,he),an.fillStyle="#FFFFFF",an.fillRect(0,0,he,he),Mr.needsUpdate=!0,Oc.needsUpdate=!0,ra(an,pi)}const hi={brushSize:1,brushPower:-1,resetDisplacement:function(){Mw()},resetSphere:function(){sphereBody.position.set(0,10,0),sphereBody.velocity.set(0,0,0)}};function ra(r,t){for(var e=he,n=he,i=r.getImageData(0,0,e,n),s=t.createImageData(e,n),o=0,a=e*n*4;o<a;o+=4){var l,c,h,d;o%(e*4)==0?(l=i.data[o],c=i.data[o+4]):o%(e*4)==(e-1)*4?(l=i.data[o-4],c=i.data[o]):(l=i.data[o-4],c=i.data[o+4]),o<e*4?(h=i.data[o],d=i.data[o+e*4]):o>e*(n-1)*4?(h=i.data[o-e*4],d=i.data[o]):(h=i.data[o-e*4],d=i.data[o+e*4]),s.data[o]=l-c+127,s.data[o+1]=h-d+127,s.data[o+2]=255,s.data[o+3]=255}t.putImageData(s,0,0)}function gs(r,t,e){return Math.max(r,Math.min(e,t))}function Sw(r,t,e,n,i,s,o){const a=s.getImageData(r,t,e,n),l=a.data;var c=!1;for(let d=0;d<l.length;d+=4){var h=l[d];o?(l[d]=gs(0,l[d]-1,i),l[d+1]=gs(0,l[d+1]-1,i),l[d+2]=gs(0,l[d+2]-1,i)):(l[d]=gs(0,255,l[d]+i),l[d+1]=gs(0,255,l[d+1]+i),l[d+2]=gs(0,255,l[d+2]+i)),h!==l[d]&&(c=!0)}return c&&s.putImageData(a,r,t),c}function $d(r,t=!0,e=!0,n=0,i=!1,s=0){const o=r.x*he,a=he-r.y*he,l=o-hi.brushSize/2,c=a-hi.brushSize/2,h=n===0?hi.brushPower:n,d=s===0?hi.brushSize:s;var u=Sw(l,c,d,d,h,an,i);return u&&(Mr.needsUpdate=!0,Oc.needsUpdate=!0,e&&ra(an,pi),t&&(gi.removeShape(mi),Bc(mi,an,Vc),gi.addShape(mi))),u}function ww(){As.setFromCamera(ac,xi),pl=As.intersectObject(ia,!1),pl.length>0&&$d(pl[0].uv)}document.addEventListener("mousemove",function(r){ac.x=r.clientX/window.innerWidth*2-1,ac.y=-(r.clientY/window.innerHeight)*2+1,sa&&zc&&(ko=!0)});Rn.domElement.addEventListener("pointerdown",function(){zc=!0,sa&&(ko=!0)});Rn.domElement.addEventListener("pointerup",function(){zc=!1});window.addEventListener("keydown",function(r){r.key==="Shift"&&(Rn.domElement.style.cursor="crosshair",yr.enabled=!1,sa=!0)});window.addEventListener("keyup",function(r){r.key==="Shift"&&(Rn.domElement.style.cursor="pointer",yr.enabled=!0,sa=!1)});window.addEventListener("resize",Ew,!1);function Ew(){xi.aspect=window.innerWidth/window.innerHeight,xi.updateProjectionMatrix(),Rn.setSize(window.innerWidth,window.innerHeight),Qd()}const jd=new rr;document.body.appendChild(jd.dom);const Sr=new Cc;Sr.add(Mr.uniforms.bumpScale,"value",.01,.8,.01);Sr.add(hi,"brushSize",1,64,1);Sr.add(hi,"brushPower",-255,255,1);Sr.add(hi,"resetDisplacement");Sr.add(hi,"resetSphere");const ku=function(r,t,e,n,i){let s=(r-t)*(i-n)/(e-t)+n;return s<n?s=n:s>i&&(s=i),s},bw=new bc(.01,16,16),Aw=new Sc({color:65280});function Tw(r,t){const e=new ce(bw,Aw);e.position.set(r.x,r.y,r.z),Ze.add(e),setTimeout(()=>{Ze.remove(e)},t)}const wr=.8,Ts={x:wr/2,y:.25,z:.345},Cw=new vr(new w(Ts.x,Ts.y,Ts.z)),fr=new ct({mass:1}),Er=new w(0,0,0);fr.addShape(Cw,Er);fr.position.set(0,10,0);const le=new LM({chassisBody:fr}),Rw=new Us(Ts.x*2,Ts.y*2,Ts.z*2),lc=new ce(Rw,new _r);Ze.add(lc);const oa=1;new Od(.1);const br=new Bs("wheel"),aa=new w(0,-1,0),la=.4,ca=-.2,ha=.2,ua=.2,da=.1,fa=12,Kd=new zd(ha,ua,da/4,fa),Zd=new zd(ha*1.2,ua*1.2,da/4,fa),Ar=new Qo(ha,ua,da/4,fa);Ar.rotateY(-Math.PI/2);Ar.rotateX(-Math.PI/2);Ar.rotateZ(-Math.PI/2);const Tr=new Qo(ha*1.2,ua*1.2,da/4,fa);Tr.rotateY(-Math.PI/2);Tr.rotateX(-Math.PI/2);Tr.rotateZ(-Math.PI/2);const Go=new ct({mass:oa,material:br});Go.addShape(Kd,new w(0,0,0),new ne().setFromEuler(0,-Math.PI/2,-Math.PI/2));le.addWheel({body:Go,position:new w(-la,ca,wr/2.2).vadd(Er),axis:new w(0,0,1),direction:aa});const cc=new ce(Ar,new _r);Ze.add(cc);const Wo=new ct({mass:oa,material:br});Wo.addShape(Kd,new w(0,0,0),new ne().setFromEuler(0,-Math.PI/2,-Math.PI/2));le.addWheel({body:Wo,position:new w(-la,ca,-wr/2.2).vadd(Er),axis:new w(0,0,-1),direction:aa});const hc=new ce(Ar,new _r);Ze.add(hc);const Xo=new ct({mass:oa,material:br});Xo.addShape(Zd,new w(0,0,0),new ne().setFromEuler(0,-Math.PI/2,-Math.PI/2));le.addWheel({body:Xo,position:new w(la,ca,wr/1.2).vadd(Er),axis:new w(0,0,1),direction:aa});const uc=new ce(Tr,new _r);Ze.add(uc);const qo=new ct({mass:oa,material:br});qo.addShape(Zd,new w(0,0,0),new ne().setFromEuler(0,-Math.PI/2,-Math.PI/2));le.addWheel({body:qo,position:new w(la,ca,-wr/1.2).vadd(Er),axis:new w(0,0,-1),direction:aa});const dc=new ce(Tr,new _r);Ze.add(dc);le.wheelBodies.forEach(r=>{r.angularDamping=.4});le.addToWorld(Kn);const Pw=new xr(br,kd,{friction:.3,restitution:0,contactEquationStiffness:1e3});Kn.addContactMaterial(Pw);document.addEventListener("keydown",r=>{const t=Math.PI/10,e=1.5;switch(r.key){case"w":case"ArrowUp":le.setWheelForce(e,2),le.setWheelForce(-e,3);break;case"s":case"ArrowDown":le.setWheelForce(-e/1.25,2),le.setWheelForce(e/1.25,3);break;case"a":case"ArrowLeft":le.setSteeringValue(t,0),le.setSteeringValue(t,1);break;case"d":case"ArrowRight":le.setSteeringValue(-t,0),le.setSteeringValue(-t,1);break}});document.addEventListener("keyup",r=>{switch(r.key){case"w":case"ArrowUp":le.setWheelForce(0,2),le.setWheelForce(0,3);break;case"s":case"ArrowDown":le.setWheelForce(0,2),le.setWheelForce(0,3);break;case"a":case"ArrowLeft":le.setSteeringValue(0,0),le.setSteeringValue(0,1);break;case"d":case"ArrowRight":le.setSteeringValue(0,0),le.setSteeringValue(0,1);break}});function Jd(){requestAnimationFrame(Jd),yr.update(),jd.update(),Date.now()-Hu>4&&ko&&(ww(),ko=!1,Hu=Date.now()),Kn.fixedStep(1/60);let r=!1;Kn.contacts.forEach(t=>{if(t.bj===gi){const e=new w;e.copy(t.bi.position),e.x+=t.ri.x,e.y+=t.ri.y,e.z+=t.ri.z,As.ray.origin.copy(e),As.ray.direction.set(0,-1,0);let n=As.intersectObject(ia,!1);if(n.length>0){let i=ku(n[0].distance,0,Fc,0,255),s=ku(n[0].distance,0,.1,1.95,.75);$d(n[0].uv,!1,!1,i,!0,Math.round(s))&&(Tw(e,8),r=!0)}}}),r&&(ra(an,pi),Mr.needsUpdate=!0,gi.removeShape(mi),Bc(mi,an,Vc,!0),gi.addShape(mi)),lc.position.copy(fr.position),lc.quaternion.copy(fr.quaternion),cc.position.copy(Go.position),cc.quaternion.copy(Go.quaternion),hc.position.copy(Wo.position),hc.quaternion.copy(Wo.quaternion),uc.position.copy(Xo.position),uc.quaternion.copy(Xo.quaternion),dc.position.copy(qo.position),dc.quaternion.copy(qo.quaternion),Qd()}function Qd(){Rn.render(Ze,xi)}Jd();
